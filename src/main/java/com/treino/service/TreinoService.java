...
import com.treino.model.TreinoClassicPhysique;
import com.treino.model.TreinoMensPhysique;
import com.treino.model.TreinoNatural;
import com.treino.model.Open;
...
public class TreinoService {  
    ...
    public void setTipoTreino(String tipo){
        switch(tipo){
            case "MensPhysique";
            treinoAtual  = new TreinoMensPhysique();
            break;
            case "ClassicPhysique";
            treinoAtual = new TreinoClassicPhysique();
            break;
            case "Open";
            treinoAtual = new Open();
            break;
            default "TreinoNatural";
            treinoAtual = new TreinoNatural();
        }
    }
